onebox_init;                                % set parameters and define transition matrices
addpath(genpath(pwd));

% Actions:
% { 1=nothing, 2=push button }

discount = .1; % temporal discount for infinite horizon
...
Qht = Q; %reshape(Q,[nq,nr,nq,nl,na]); % joint value of state and action. Format: b2 * r * b1 * l * a
